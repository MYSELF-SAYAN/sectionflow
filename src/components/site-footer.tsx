...
const LINKS = {
  ...
  Categories: [
    { label: 'Creative & SVG', href: '/docs/templates' },
    { label: 'Split & Fragment', href: '/docs/templates' },
    { label: '3D & Perspective', href: '/docs/templates' },
    { label: 'Scroll physics', href: '/docs/templates' },
    { label: 'Particles', href: '/docs/templates' },
    { label: 'Premium effects', href: '/docs/templates' },
  ],
  Resources: [
