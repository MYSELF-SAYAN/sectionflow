...
export function DocsHomeContent() {
  ...
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(45,212,191,0.24),transparent_32%),linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-6 sm:p-8 lg:p-10">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#101014] p-5">
...
`}</code>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {featured.map((transition) => (
              <Link key={transition.slug} href={`/docs/transitions/${transition.slug}`} className="rounded-2xl border border-white/10 bg-black/20 p-5 transition hover:border-teal-400/40 hover:bg-white/5">
      ...
      <section className="rounded-2xl border border-white/10 bg-[linear-gradient(135deg,rgba(45,212,191,0.18),rgba(255,255,255,0.02))] p-6 sm:p-8">
