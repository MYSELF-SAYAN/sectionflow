...
export interface TransitionMeta {
  ...
  featured?: boolean;
  group?: 'Wave' | 'SVG' | 'Perspective' | 'Scroll' | 'Grid' | 'Morph' | 'Parallax' | 'Other';
  tags?: string[];
  prompt?: string;
}
...
export const transitions: TransitionMeta[] = [
  ...
  { slug: 'circular-portal', name: 'Circular Portal', category: 'Creative', engine: 'framer-motion', description: 'The next section blooms out of a circular portal in the center.', status: 'available', viewing: 'long', featured: true, group: 'SVG', tags: ['portal', 'mask'] },
  { slug: 'spotlight-reveal', name: 'Spotlight Reveal', category: 'Creative', engine: 'framer-motion', description: 'A soft spotlight mask grows until the next section fills the frame.', status: 'available', viewing: 'long', featured: true, group: 'SVG', tags: ['spotlight', 'mask'] },
  { slug: 'ink-spread', name: 'Ink Spread', category: 'Creative', engine: 'framer-motion', description: 'Two organic ink blots spread and merge to reveal the next section.', status: 'available', viewing: 'long', featured: true, group: 'SVG', tags: ['ink', 'morph'] },
  ...
  { slug: 'liquid-morph', name: 'Liquid Morph', category: 'Creative', engine: 'framer-motion', description: 'Four organic ink-like blobs grow from the corners and merge to flood the viewport, revealing the next section through pure shape and motion.', status: 'available', viewing: 'long', group: 'Morph', tags: ['liquid', 'blob', 'mask'] },
  { slug: 'mesh-gradient-morph', name: 'Mesh Gradient Morph', category: 'Creative', engine: 'framer-motion', description: 'Animated mesh gradient nodes drift across the screen, eroding the outgoing section while a colour-bleeding overlay bridges the two backgrounds.', status: 'available', viewing: 'standard', group: 'Morph', tags: ['mesh', 'gradient', 'morph'] },
  { slug: 'glass-distortion', name: 'Glass Distortion', category: 'Creative', engine: 'framer-motion', description: 'A frosted-glass panel slides up from below, creating lenticular refraction across the viewport before dissolving to reveal the next section.', status: 'available', viewing: 'standard', group: 'SVG', tags: ['glass', 'blur', 'distortion'] },
  { slug: 'ripple-reveal', name: 'Ripple Reveal', category: 'Creative', engine: 'framer-motion', description: 'Five concentric ripple rings expand outward from the viewport centre, the innermost wave acting as a growing reveal mask. Outer rings glow with a cyan halo.', status: 'available', viewing: 'long', group: 'SVG', tags: ['ripple', 'mask', 'circles'] },
  { slug: 'svg-shape-morph', name: 'SVG Shape Morph', category: 'Premium', engine: 'framer-motion', description: 'A clip-path mask morphs through a sequence of shapes — diamond → starburst → hexagonal shield → full rectangle — progressively revealing the incoming section.', status: 'available', viewing: 'long', group: 'SVG', tags: ['svg', 'shape', 'morph', 'mask'] },
  ...
  { slug: 'infinite-tunnel', name: 'Infinite Tunnel', category: '3D', engine: 'framer-motion', description: 'A perspective tunnel of shrinking frames flies toward the camera. Each nested frame rushes past the viewer, creating a warp-speed telescoping illusion.', status: 'available', viewing: 'standard', group: 'Perspective', tags: ['tunnel', '3d', 'depth'] },
  { slug: 'spatial-warp', name: 'Spatial Warp', category: '3D', engine: 'framer-motion', description: 'Space itself bends between sections. Horizontal strips skew and stretch in a gravitational-lens wave before snapping back with the new section in place.', status: 'available', viewing: 'standard', group: 'Perspective', tags: ['warp', 'skew', 'space'] },
  { slug: 'hero-morph', name: 'Hero Morph', category: '3D', engine: 'framer-motion', description: 'A small rounded hero card at the centre morphs outward into a full-bleed panel. Corners soften and sharpen as it expands, with an ambient glow ring for depth.', status: 'available', viewing: 'standard', group: 'Perspective', tags: ['hero', 'morph', '3d'] },
  { slug: 'dynamic-portal', name: 'Dynamic Portal', category: '3D', engine: 'framer-motion', description: 'A glowing iris portal opens from a single point at screen centre, expanding with a spinning ring until it consumes the entire viewport.', status: 'available', viewing: 'standard', group: 'SVG', tags: ['portal', 'iris', '3d'] },
  { slug: 'camera-flythrough', name: 'Camera Flythrough', category: '3D', engine: 'framer-motion', description: 'The camera rockets through a series of receding depth planes before landing inside the next section. Each plane rushes past the viewer like a warp-speed jump.', status: 'available', viewing: 'standard', group: 'Perspective', tags: ['camera', 'flythrough', '3d', 'depth'] },
  { slug: 'neon-corridor', name: 'Neon Corridor', category: '3D', engine: 'framer-motion', description: 'The camera flies down a neon-lit corridor of receding frames that narrow to a point before detonating into the next full-screen section — a cyberpunk flythrough.', status: 'available', viewing: 'standard', group: 'Perspective', tags: ['neon', 'corridor', '3d'] },
  { slug: 'starfield-warp', name: 'Starfield Warp', category: '3D', engine: 'framer-motion', description: 'Hundreds of star particles stretch into hyperspace streaks and converge toward a central vanishing point, accelerating the viewer into the next section at warp speed.', status: 'available', viewing: 'standard', group: 'Perspective', tags: ['stars', 'hyperspace', 'warp'] },
  ...
  { slug: 'thanos-snap', name: 'Thanos Snap', category: 'Particles', engine: 'framer-motion', description: 'The outgoing section dissolves into fine particles that fly outward in random directions, creating a sense of chaos and disintegration.', status: 'available', viewing: 'standard', group: 'Other', tags: ['particles', 'chaos', 'disintegration'] },
  { slug: 'energy-burst', name: 'Energy Burst', category: 'Particles', engine: 'framer-motion', description: 'An energy shockwave erupts from viewport centre — three pulsing rings and 24 radial rays bleach the outgoing section before the incoming one materialises from the glow.', status: 'available', viewing: 'standard', group: 'Other', tags: ['energy', 'shockwave', 'burst'] },
