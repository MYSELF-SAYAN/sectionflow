...
export const transitions: TransitionMeta[] = [
  ...
  { slug: 'reality-tear', name: 'Reality Tear', category: 'Split & Fragment', engine: 'framer-motion', description: 'A jagged tear appears in the center, ripping the page apart like fabric. The next page exists underneath and stretches into view.', status: 'available', viewing: 'standard', tags: ['tear', 'fabric', 'rip'] },
  ...
  { slug: 'origami-fold', name: 'Origami Fold', category: '3D', engine: 'framer-motion', description: 'The page folds into intricate paper structures, then unfolds into an entirely different layout.', status: 'available', viewing: 'standard', tags: ['origami', 'fold', 'paper'] },
  { slug: 'dimensional-slice', name: 'Dimensional Slice', category: '3D', engine: 'framer-motion', description: 'Invisible planes slice the page into thick 3D slabs that slide independently, exposing the next section between them.', status: 'available', viewing: 'standard', tags: ['slice', '3d', 'slabs'] },
  { slug: 'gravity-flip', name: 'Gravity Flip', category: 'Creative', engine: 'framer-motion', description: 'The world\'s gravity rotates 90° or 180°. All UI elements fall toward the new direction and settle into the next layout.', status: 'available', viewing: 'standard', tags: ['gravity', 'physics', 'flip'] },
  ...
  { slug: 'page-curl', name: 'Page Curl', category: '3D', engine: 'framer-motion', description: 'A realistic page curl begins from any corner, with thickness, shadows, and bending, revealing the content beneath.', status: 'available', viewing: 'standard', tags: ['curl', 'page', 'bend'] },
  { slug: 'mirror-reflection', name: 'Mirror Reflection', category: 'Creative', engine: 'framer-motion', description: 'The screen becomes a mirror. The reflection starts behaving differently, then the reflected world replaces reality.', status: 'available', viewing: 'standard', tags: ['mirror', 'reflection'] },
  { slug: 'elastic-stretch', name: 'Elastic Stretch', category: 'Creative', engine: 'framer-motion', description: 'The page behaves like rubber—stretching, wobbling, snapping, and rebounding into the next section.', status: 'available', viewing: 'standard', tags: ['elastic', 'stretch', 'rubber'] },
