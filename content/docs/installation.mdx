...
Create `components/sectionflow/core/types.ts`, `section-flow.tsx`, and `registry.ts`. Copy their contents from the [API Reference](/docs/api) or the Code tab of any transition.
